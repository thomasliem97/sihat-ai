...
Deploy:
  ...
  modal deploy ai-service/modal_app.py
...
class MedGemmaModel:
    ...
    def classify(self, payload: dict[str, Any]) -> dict[str, Any]:
                ...
                "content": [
                    {"type": "image", "image": pil},
                    {
                        ...
                        "text": (
                            ...
                            '{"modality":"xray|dermatology|ct|mri|other","confidence":0-1}'
                        ),
                    },
                ],
            }
        ...
        modality = str(raw.get("modality", "xray")).lower()
        if modality == "other":
            modality = "xray"
        if modality not in {"xray", "dermatology", "ct", "mri"}:
            modality = "xray"
        return {
            "modality": modality,
