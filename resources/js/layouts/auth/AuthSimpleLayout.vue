...
<template>
    <div
        class="atlas-field flex min-h-svh flex-col items-center justify-center gap-6 p-6 md:p-10"
    >
        <div class="paper-panel paper-panel--focal w-full max-w-md p-8 md:p-10">
